...
class ColorSaturateTest {
    ...
    @Test
    fun testSaturateRed() {
        val red = ColorHSL(0f, 0.5f, 0.5f, 1f)
    ...
    fun testSaturateGreen() {
        val green = ColorHSL(120f, 0.6f, 0.4f, 1f)
    ...
    fun testSaturateBlue() {
        val blue = ColorHSL(240f, 0.8f, 0.6f, 1f)
    ...
    fun testSaturateGray() {
        val gray = ColorHSL(0f, 0f, 0.5f, 1f)
    ...
    fun testSaturateDesaturate() {
        val color = ColorHSL(180f, 0.8f, 0.4f, 0.9f)
    ...
    fun testSaturateNoChange() {
        val color = ColorHSL(60f, 0.7f, 0.3f, 1f)
    ...
    fun testSaturateZero() {
        val color = ColorHSL(300f, 0.6f, 0.5f, 1f)
    ...
    fun testSaturateFullSaturation() {
        val color = ColorHSL(45f, 0.3f, 0.6f, 1f)
