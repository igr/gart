...
class ColorShadeTest {
    ...
    @Test
    fun testShadeRed() {
        val red = ColorHSL(0f, 1f, 0.5f, 1f)
    ...
    @Test
    fun testShadeGreen() {
        val green = ColorHSL(120f, 1f, 0.5f, 1f)
    ...
    @Test
    fun testShadeBlue() {
        val blue = ColorHSL(240f, 1f, 0.5f, 1f)
    ...
    @Test
    fun testShadeWhite() {
        val white = ColorHSL(0f, 0f, 1f, 1f)
    ...
    @Test
    fun testShadeZero() {
        val color = ColorHSL(60f, 0.7f, 0.6f, 1f)
