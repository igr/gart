...
class ColorHSLATest {
    ...
    fun testRGBAtoHSLA_red() {
        val red = ColorHSL.of(Color4f(1f, 0f, 0f, 1f))
    ...
    fun testRGBAtoHSLA_green() {
        val green = ColorHSL.of(Color4f(0f, 1f, 0f, 1f))
    ...
    fun testRGBAtoHSLA_blue() {
        val blue = ColorHSL.of(Color4f(0f, 0f, 1f, 1f))
    ...
    fun testRGBAtoHSLA_white() {
        val white = ColorHSL.of(Color4f(1f, 1f, 1f, 1f))
    ...
    fun testRGBAtoHSLA_black() {
        val black = ColorHSL.of(Color4f(0f, 0f, 0f, 1f))
    ...
    fun testRGBAtoHSLA_gray() {
        val gray = ColorHSL.of(Color4f(0.5f, 0.5f, 0.5f, 1f))
    ...
    fun testHSLAtoRGBA_red() {
        val red = ColorHSL(0f, 1f, 0.5f, 1f).toColor4f()
    ...
    fun testHSLAtoRGBA_green() {
        val green = ColorHSL(120f, 1f, 0.5f, 1f).toColor4f()
    ...
    fun testHSLAtoRGBA_blue() {
        val blue = ColorHSL(240f, 1f, 0.5f, 1f).toColor4f()
    ...
    fun testHSLAtoRGBA_white() {
        val white = ColorHSL(0f, 0f, 1f, 1f).toColor4f()
    ...
    fun testHSLAtoRGBA_black() {
        val black = ColorHSL(0f, 0f, 0f, 1f).toColor4f()
    ...
    fun testHSLAtoRGBA_gray() {
        val gray = ColorHSL(0f, 0f, 0.5f, 1f).toColor4f()
