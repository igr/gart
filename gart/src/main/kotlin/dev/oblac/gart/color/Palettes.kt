...
object Palettes {
    ...
    fun mixPalette(num: Int): Palette {
        return when (num) {
            1 -> mix1
            2 -> mix2
            3 -> mix3
            ...
            14 -> mix14
            15 -> mix15
            else -> throw IllegalArgumentException("Unknown MIX palette number: $num")
        }
    }
    ...
    fun colormapPalette(num: Int): Palette {
        return when (num) {
            1 -> colormap001
            2 -> colormap002
            3 -> colormap003
            ...
            132 -> colormap132
            133 -> colormap133
            else -> throw IllegalArgumentException("Unknown COLORMAP palette number: $num")
        }
    }
