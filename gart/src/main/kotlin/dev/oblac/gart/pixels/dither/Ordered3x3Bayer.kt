...
fun ditherOrdered3By3Bayer(bitmap: Pixels, pixelSize: Int = 1, colorCount: Int = 256) {
    ...
    for (y in 0 until height step pixelSize) {
        for (x in 0 until width step pixelSize) {
            ...
            val indexX = (x / pixelSize) % 3
            val indexY = (y / pixelSize) % 3
            val threshold = (order3By3Bayer[indexY][indexX] * stepSize / 9)
...
private val order3By3Bayer = arrayOf(
    intArrayOf(0, 7, 3),
    intArrayOf(6, 5, 2),
    intArrayOf(4, 1, 8)
)
