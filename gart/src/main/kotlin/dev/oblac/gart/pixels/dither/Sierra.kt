...
fun ditherSierra(bitmap: Pixels, pixelSize: Int = 1, colorCount: Int = 256) {
    ...
    for (y in 0 until height step pixelSize) {
        for (x in 0 until width step pixelSize) {
            ...
            // Distribute error using Sierra weights
            ...
            if (rightX < width) 
                bitmap.addBlockColor(rightX, y, pixelSize, (errorR * 5.0 / 32.0).toInt(), (errorG * 5.0 / 32.0).toInt(), (errorB * 5.0 / 32.0).toInt())
            
            if (rightX2 < width) 
                bitmap.addBlockColor(rightX2, y, pixelSize, (errorR * 3.0 / 32.0).toInt(), (errorG * 3.0 / 32.0).toInt(), (errorB * 3.0 / 32.0).toInt())
            ...
            if (bottomY < height) {
                ...
                bitmap.addBlockColor(x, bottomY, pixelSize, (errorR * 5.0 / 32.0).toInt(), (errorG * 5.0 / 32.0).toInt(), (errorB * 5.0 / 32.0).toInt())
            ...
            if (bottomY2 < height) {
                if (bottomLeftX >= 0) 
                    bitmap.addBlockColor(bottomLeftX, bottomY2, pixelSize, (errorR * 2.0 / 32.0).toInt(), (errorG * 2.0 / 32.0).toInt(), (errorB * 2.0 / 32.0).toInt())
            
                bitmap.addBlockColor(x, bottomY2, pixelSize, (errorR * 3.0 / 32.0).toInt(), (errorG * 3.0 / 32.0).toInt(), (errorB * 3.0 / 32.0).toInt())
            
                if (bottomRightX < width) 
                    bitmap.addBlockColor(bottomRightX, bottomY2, pixelSize, (errorR * 2.0 / 32.0).toInt(), (errorG * 2.0 / 32.0).toInt(), (errorB * 2.0 / 32.0).toInt())
            }
        }
    }
}
