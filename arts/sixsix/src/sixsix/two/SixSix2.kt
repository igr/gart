...
import sixsix.two.Cell.CellColor
import java.util.*

// #: mDGSXAX5mrSJDZ2T0KQI28Fkzcnckle4T05A+FOOxIlKsuLSQs4OrQynlYcG7Rk52wZLbEesnhyWB0NyYA6Rh2POVDJfTmEs
fun main(args: Array<String>) {
    val headless = detectHeadlessFlags(args)
    val gart = Gart.of("sixsix2", 1080, 1080)
    println(gart)
